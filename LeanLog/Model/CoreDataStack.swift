...
class CoreDataStack {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "me.petersimpson.LeanLog" in the application's documents Application Support directory.
...
*/
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        // DELETE FOR ICLOUD?
        // let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("LeanLog.sqlite")
